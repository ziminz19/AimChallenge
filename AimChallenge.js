...
export class AimChallenge extends Scene {
    constructor() {
        ...
        this.initial_camera_location = Mat4.look_at(vec3(0, 0, 70), vec3(0, 0, -10), vec3(0, 1, 0));
    }
    ...
    display(context, program_state) {
        ...
        model_transform_targets[2] = Mat4.translation(0, -1.25, 0).times(Mat4.scale(3, 3, 3)).times(model_transform_targets[2]);
